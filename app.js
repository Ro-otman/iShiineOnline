...
await fs.mkdir(path.join(__dirname, 'public', 'uploads', 'users'), { recursive: true });
...
httpServer.listen(env.PORT, '0.0.0.0', () => {
  console.log(`ishiine-online API listening on http://localhost:${env.PORT} (${env.NODE_ENV})`);
});
